...
(function () {
  ...
  // data-lightbox="qthumbs-XX">. Clicking opens a full-size
  // image in a centered modal. Esc or click-outside closes.
  ...
  (function () {
    ...
    function open(href, caption) {
      ...
      overlay.addEventListener('click', function (e) {
        // Click anywhere in the overlay (including the image)
        // closes. The image is inside the overlay so a click
        // on it bubbles up.
        close();
      });
